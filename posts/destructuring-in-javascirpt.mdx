...
date: '2022-06-18'
thumbnailUrl: /images/destruction.png
excerpt: "The two most used data structures in JavaScript are `Object` and `Array`. But when we pass those to a `function`, it
...
We have an existing `object` on the right side, that we want to *split* into `variables`. The left side
...
property items. The pattern on the *left side* of the assignment has the same structure:
...
<img src="https://cdn.hashnode.com/res/hashnode/image/upload/v1645090383953/6c-YYteLX.png" alt="aklsdf" />
