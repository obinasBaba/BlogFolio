...
date: '2021-06-18'
thumbnailUrl: /images/rest_parameter.png
excerpt: "Have you ever wondered how the built-in functions like `Math.max(arg1, arg2, ..., argN)  ` support an arbitrary number
